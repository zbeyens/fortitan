...
export default class Background {
    constructor(state) {
    	...
    	this.bg = new Phaser.TileSprite(window.game, 0, 0, cfg.bgWidth, cfg.bgHeight, cfg.bgKey);
    	// fixedToCamera = true
     //    this.bg.tint = 0x0094FF;
    	// this.bg = state.add.sprite(0, 0, 'background');
    	// this.bg.scale.setTo(2);
        this.bg.scale.setTo(cfg.bgScale);

        window.game.world.setBounds(0, 0, cfg.bgWidth * cfg.bgScale, cfg.bgHeight * cfg.bgScale);
