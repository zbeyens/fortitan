...
const cfg = {
  ...
  images: {
    mainMenuBg: ["img/icons/bg-2.png"],
    mainMenuTitle: ["img/title.png"],
    bg: ["img/background/sun.png"],
    players: ["img/temp/p1.png"],
    grounds: ["img/tiles/Spring/128x128/GrassMid.png"],
    trees: ["img/tree/Asset 1.png"],

    inventoryBar: ["img/InventoryBar1.png"],
    pickaxes: ["img/SpriteWay/WoodPick.png"]
