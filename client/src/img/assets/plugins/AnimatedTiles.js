...
var AnimatedTiles = function AnimatedTiles(scene) {
    ...
    */
    ...
    // TODO: Array or object for multiple tilemaps support id:2 gh:6 ic:gh
    // TODO: reference to layers too, and which is activated or not id:4 gh:8 ic:gh
    this.map = null;

    // Array with all tiles to animate
    // TODO: Turn on and off certain tiles. id:6 gh:10 ic:gh
    this.animatedTiles = [];
...
AnimatedTiles.prototype = {
    ...
    init: function init(map) {
        ...
        // TODO: Check if map is initilized already, if so do it again but overwrite the old. id:7 gh:11 ic:gh
    ...
    setRate: function setRate(rate) {
        ...
        // TODO: if passing an object -> check properties matching object and set rate id:1 gh:5 ic:gh
    },
