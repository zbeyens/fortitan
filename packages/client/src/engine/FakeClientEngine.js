...
import MyGameEngineS from '@fortitan/game-server/MyGameEngineS';
import FakeServerEngine from '@fortitan/game-server/FakeServerEngine';
...
// export const clientEngine = new FakeClientEngine()
